...
def run_backtest_2percent_commission():
    print("="*95)
    print("  FIXED LIABILITY (£15 PER BET) LAY SYSTEM BACKTEST WITH 2.0% BETFAIR COMMISSION")
    print("="*95)
    ...
    # Lay Target: RankWorst <= 2, Score < 0, Odds <= 20.0
    ...
    # 2.0% Betfair Commission Model
    # If Loss (Horse Wins): Loss = -FIXED_LIABILITY (-£15.00)
    # If Win for Lay (Horse Loses): Profit = Stake * 0.98 (2% commission)
    ...
    print("="*95)
    print("  MONTH-BY-MONTH LAY SYSTEM PERFORMANCE (2.0% BETFAIR COMMISSION)")
    print("="*95)
    ...
    print(f"\n  OVERALL FIXED LIABILITY (£15 PER BET @ 2% COMMISSION) SUMMARY:")
...
if __name__ == '__main__':
    run_backtest_2percent_commission()
