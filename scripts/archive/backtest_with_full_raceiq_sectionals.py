...
def run_backtest_raceiq_sectionals():
    print("="*95)
    print("  ZERO-LOOKAHEAD LAY SYSTEM USING SCRAPED RACINGTV RACEIQ SECTIONALS & STRIDE")
    print("="*95)

    conn = pyodbc.connect(CONN_STR)
    
    print("\n[1/4] Loading runner results & RaceIQ sectional/stride metrics...")
    sql = """
    SELECT 
        r.RaceDate,
        r.RaceTime,
    ...
    # MASTER SCORE WITH RACEIQ METRICS
    ...
    # RACINGTV RACEIQ SECTIONAL DEDUCTIONS
    ...
    print("="*95)
    print("  MONTH-BY-MONTH PERFORMANCE (RACINGTV SECTIONALS + STRIDE + TOP SPEED)")
    print("="*95)
    ...
    print(f"\n  OVERALL RACINGTV RACEIQ SECTIONAL & STRIDE SYSTEM SUMMARY:")
...
if __name__ == '__main__':
    run_backtest_raceiq_sectionals()
